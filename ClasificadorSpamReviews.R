...
# 3.1 Conversión de typo de columnas ----
...
#Encontrar un valor de lambda optimo
...
# 7 Predecir Z en X_test -----
Z_predicted<-predict(fit, s=lambda_opt, newx= X_test, type="class")

# 8. Medir eficiencia -----
accuracy<-mean(Z_test==Z_predicted)
coef(fit, s=lambda_opt)[400:420]
